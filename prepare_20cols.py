...
attacks = [
    {'name': 'SYN_DoS', 'data': r'data\SYN_DoS_dataset.csv\SYN_DoS_dataset.csv', 'label': r'data\SYN_DoS_labels.csv\SYN_DoS_labels.csv'},
    {'name': 'Mirai', 'data': r'data\Mirai_dataset.csv\Mirai_dataset.csv', 'label': r'data\mirai_labels.csv\mirai_labels.csv'},
    {'name': 'SSDP_Flood', 'data': r'data\SSDP_Flood_dataset.csv\SSDP_Flood_dataset.csv', 'label': r'data\SSDP_Flood_labels.csv\SSDP_Flood_labels.csv'}
]
