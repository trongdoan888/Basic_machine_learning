...
class Admin_Helper {
	...
	public static function get_common_settings() {
		...
		$options = array(
			...
			'uagb_old_user_less_than_3'          => \UAGB_Helper::is_old_user_less_than_v3(),
			...
			'uag_disable_css_cache'              => \UAGB_Admin_Helper::get_admin_settings_option( 'uag_disable_css_cache', 'disabled' ),
		);
