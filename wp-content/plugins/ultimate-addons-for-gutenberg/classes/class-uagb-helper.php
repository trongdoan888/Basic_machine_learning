...
if ( ! class_exists( 'UAGB_Helper' ) ) {
	...
	final class UAGB_Helper {
		...
		/**
		 * Check if user is old user less than v3.
		 *
		 * @since 3.0.0
		 * 
		 * @return bool True if user is old user less than v3, false otherwise.
		 */
		public static function is_old_user_less_than_v3() {
			return 'yes' === get_option( 'uagb-old-user-less-than-3', 'no' );
		}

		/**
		 * Check if v2 blocks are enabled.
		 *
		 * @since 3.0.0
		 * 
		 * @return bool True if v2 blocks are enabled, false otherwise.
		 */
		public static function is_v2_blocks_enabled() {
			return 'yes' === get_option( 'register-v2-blocks', 'no' ); 
		}
	}
