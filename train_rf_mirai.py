...
print(f"[1/8] Đang nạp dữ liệu từ: {file_path}")
start_time = time.time()
df = pd.read_csv(file_path)

print("[2/8] Đang làm sạch dữ liệu (Loại bỏ NaN và Vô cực)...")
...
print("[3/8] Đang chia tập Huấn luyện và Kiểm thử...")
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, stratify=y, random_state=42)

print("[4/8] Đang huấn luyện Rừng ngẫu nhiên (100 cây)...")
...
print("[5/8] Đang dự đoán trên tập Kiểm thử...")
...
print("[6/8] Đang lưu mô hình đã huấn luyện...")
os.makedirs('models', exist_ok=True)
joblib.dump(rf_model, 'models/rf_mirai_model.pkl')
print("      -> Đã lưu mô hình: models/rf_mirai_model.pkl")

print("[7/8] Đang xuất biểu đồ Ma trận nhầm lẫn...")
...
print("[8/8] Đang trích xuất và vẽ Top Đặc trưng quan trọng...")
