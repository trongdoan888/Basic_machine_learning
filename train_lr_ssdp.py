...
print("[7/7] Đang lưu mô hình và xuất biểu đồ Ma trận nhầm lẫn & Trọng số...")
os.makedirs('models', exist_ok=True)
joblib.dump(lr_model, 'models/lr_ssdp_model.pkl')
joblib.dump(scaler, 'models/lr_ssdp_scaler.pkl')
print("      -> Đã lưu mô hình: models/lr_ssdp_model.pkl")
